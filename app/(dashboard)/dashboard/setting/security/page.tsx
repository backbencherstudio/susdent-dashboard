            ...
            <form>
                ...
                <div>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="relative">
                          <Input type={type2} className="w-full px-4 py-3 text-sm font-normal bg-[#181E2A] border border-[#222733] rounded outline-none focus-visible:ring-0 focus-visible:border-primary-color text-white" placeholder="New Password"/>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="relative">
                          <Input type={type3} className="w-full px-4 py-3 text-sm font-normal bg-[#181E2A] border border-[#222733] rounded outline-none focus-visible:ring-0 focus-visible:border-primary-color text-white" placeholder="Current Password"/>
  ...
  return (
    ...
    <div className='bg-secondary-bg p-4 rounded-[8px] mt-4'>
        ...
        <div className="py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-[#1B202C]">
            ...
            <button className="bg-primary-color text-white px-5 py-[10px] rounded text-sm font-normal cursor-pointer">Deactivate</button>
        </div>
