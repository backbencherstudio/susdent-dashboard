...
import { SuspendModal } from "../video-creator/SuspendModal";
    ...
    <>
      ...
      <div className="flex flex-wrap gap-4 items-center justify-between mb-4">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <SuspendModal row={userDet} status={userDet.status} userId={id as string} />
        ...
        <div>
          ...
          <div className="my-4 flex items-center gap-4">
            {
              userDet.status === "active" ?
                <p className="text-[#2ECC71] text-xs">{userDet.status.charAt(0).toUpperCase() + userDet.status.slice(1)}</p> :
                <p className="text-[#e70d0d] text-xs">{userDet.status.charAt(0).toUpperCase() + userDet.status.slice(1)}</p>
            }
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm">Joined: {convertDateStr(userDet.created_at)}</p>
            </div>
