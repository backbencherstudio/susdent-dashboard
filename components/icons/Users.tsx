...
export default function Users({className} : {className?: string}) {
  return (
    ...
    <path d="M12.1607 10.87C12.0607 10.86 11.9407 10.86 11.8307 10.87C9.4507 10.79 7.5607 8.84 7.5607 6.44C7.5607 3.99 9.5407 2 12.0007 2C14.4507 2 16.4407 3.99 16.4407 6.44C16.4307 8.84 14.5407 10.79 12.1607 10.87Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
